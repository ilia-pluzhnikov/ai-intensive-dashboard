...
## Календарь — Поток #5 (Май–Июнь 2026)

**Даты потока:** 26 мая — 12 июня 2026 (+ подготовительная неделя 19–24 мая)
**Расписание созвонов:** Вторник + Пятница, 18:00 МСК, 1.5–2 часа
**Подготовительная неделя:** 19–24 мая — буферная настройка (Claude + оплата для РФ); настроечный созвон 22 мая (Пт, 18:00 МСК)

| Созвон | Дата | День | Тема |
|--------|------|------|------|
| 1 | 26 мая | Вторник | Обзор рынка AI (почему Claude), лестница освоения, выбор проекта |
| 2 | 29 мая | Пятница | Среды (Web/Desktop/Terminal), контекст-файлы, оркестрация моделей и лимиты |
| 3 | 2 июня | Вторник | Разбор проектов, Git, хостинг и деплой, команды Claude Code |
| 4 | 5 июня | Пятница | Skills, субагенты, хуки, MCP, экономика агентов |
| 5 | 9 июня | Вторник | Context Engineering: слои контекста, поверхность внимания, экономика кэша |
| 6 | 12 июня | Пятница | Демо-день: анатомия агента, 5 слоёв памяти, проактивность (Heartbeat/Cron) |

> **Бонусные лекции (по запросу группы):** LLM для начинающих · Продуктовое мышление · Продвижение и личный бренд (NotebookLM, маркетинг).

> **Историческое:** Поток #3 (17 марта — 3 апреля 2026) → `data/cohort-3-archive.json` (коммит 298564f). Поток #4 (14 — 30 апреля 2026) → `data/cohort-4-archive.json` (коммит af97c9f).
